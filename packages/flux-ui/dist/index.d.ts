...
declare const elevation: {
     ...
     */
    readonly tooltip: "shadow-md";
    readonly popover: "shadow-lg";
    readonly drawer: "shadow-xl";
    readonly modal: "shadow-2xl";
};
